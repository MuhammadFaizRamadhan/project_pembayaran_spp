<aside class="fixed top-0 left-0 h-full w-64 bg-white shadow-md z-40">
    <div class="p-6 border-b flex items-center gap-3">
        ...
        <h1 class="text-l font-bold text-blue-700 leading-tight">SMA Muhammadiyah 3 Gresik</h1>
    </div>
    <nav class="mt-6">
        ...
        <a href="/admin/rekap_pembayaran" class="block px-6 py-3 text-gray-700 hover:bg-blue-100">Rekap Pembayaran</a>
