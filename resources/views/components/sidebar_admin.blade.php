<aside class="w-64 bg-white shadow-md">
    ...
    <nav class="mt-6">
        ...
        <a href="/admin/data_pembayaran" class="block px-6 py-3 text-gray-700 hover:bg-orange-100">Data Pembayaran</a>
        <a href="/admin/data_siswa" class="block px-6 py-3 text-gray-700 hover:bg-orange-100">Data Siswa</a>
        <a href="{{ route('admin.profile') }}" class="block px-6 py-3 text-gray-700 hover:bg-orange-100">Profile</a>
    </nav>
